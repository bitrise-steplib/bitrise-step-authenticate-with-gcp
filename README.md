...
[![Step changelog](https://shields.io/github/v/release/bitrise-steplib/bitrise-step-authenticate-with-gcp?include_prereleases&label=changelog&color=blueviolet)](https://github.com/bitrise-steplib/bitrise-step-authenticate-with-gcp/releases)
...
We welcome [pull requests](https://github.com/bitrise-steplib/bitrise-step-authenticate-with-gcp/pulls) and [issues](https://github.com/bitrise-steplib/bitrise-step-authenticate-with-gcp/issues) against this repository.
